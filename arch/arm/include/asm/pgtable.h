...
***************************************************************************
*/
/* 将vmalloc区域顶部压缩，留给amp使用 */
//#define VMALLOC_END		0xff000000UL
#define VMALLOC_END		0xfc400000UL //extra 2MB gap and 32MB static fix map space for amp yejc

/* 下面的在amp_config.h中定义 */
/*
#define AMPMAP_OFFSET		(2*1024*1024) //extra 8MB gap and 32MB static fix map space for amp yejc
#define AMPMAP_START		(VMALLOC_END + AMPMAP_OFFSET) //0xfca00000
#define AMPMAP_END		0xfea00000UL
...
#define SRAMMAP_END		0xfeb10000UL
