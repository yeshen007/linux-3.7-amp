...
static void __init socfpga_ucosii_reserve(void)
{
		...
		/* 将1e000000开始的32m物理内存移出reserved区 */
        memblock_free(0x1E000000, 32*SZ_1M);	
		/* 将1e000000开始的32m物理内存移出memory区 */
